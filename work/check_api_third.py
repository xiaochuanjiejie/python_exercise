...
ISOTIMEFORMAT='%Y/%m/%d'
file_path = '/data/behavior/hd/http/time.strftime( ISOTIMEFORMAT, time.localtime())'
...
last_minute_file = Popen('grep "00:00:" /Users/xujunchuan/Documents/info2.log',shell=True, stdout=PIPE, stderr=PIPE)
